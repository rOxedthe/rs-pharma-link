      ...
      <section className="section-pad relative overflow-hidden" style={{ background: "var(--color-dark)", paddingTop: "10rem" }}>
        <div className="section-container">
          <SectionTransition stagger className="content-measure mx-auto lg:mx-0 text-center lg:text-left">
            <p className="font-mono-label section-kicker" style={{ color: "var(--color-medical)" }}>— ABOUT US</p>
            ...
            <p className="text-lg leading-relaxed mx-auto lg:mx-0" style={{ color: "rgba(244,241,235,0.6)", fontFamily: "var(--font-body)" }}>
      ...
      <section className="section-pad" style={{ background: "var(--color-bg)" }}>
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div ref={doorRef} className="scene-frame">
            ...
            <SectionTransition stagger className="content-measure mx-auto text-center lg:text-left">
              <p className="font-mono-label section-kicker" style={{ color: "var(--color-medical)" }}>— OUR MISSION</p>
      ...
      <section className="section-pad" style={{ background: "var(--color-dark)" }}>
        <div className="section-container" style={{ maxWidth: "56rem" }}>
          <SectionTransition className="section-header mb-16">
            <p className="font-mono-label section-kicker" style={{ color: "var(--color-medical)" }}>— OUR JOURNEY</p>
